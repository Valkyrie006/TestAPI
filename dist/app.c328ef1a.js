...
var BASE_URL = 'https://gbd5npo4g1.execute-api.us-east-2.amazonaws.com/production/temples/all';
...
function _getTodo() {
  _getTodo = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post("".concat(BASE_URL, "/"), {});
